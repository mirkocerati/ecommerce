...
<section class="page-header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">Checkout: completa il tuo acquisto</h1>
				</div>
			</div>
		</div>
	</div>
         ...
         <div class="row">
            <div class="col-md-8">
               <div class="block billing-details">
                  <h4 class="widget-title">Informazioni di fatturazione</h4>
                  <form class="checkout-form">
                     ...
                     <div class="form-group">
                        <label for="user_country">Paese</label>
                        <input type="text" class="form-control" id="Paese">
                     </div>
                  </form>
               </div>
               <div class="block">
                  <h4 class="widget-title">Metodo di pagamento</h4>
                  ...
                  <div class="checkout-product-details">
                     <div class="payment">
                        <div class="card-details">
                           <form  class="checkout-form">
                              <div class="form-group">
                                 <label for="card-number">Numero della carta <span class="required">*</span></label>
                                 <input  id="card-number" class="form-control"   type="tel" placeholder="•••• •••• •••• ••••">
                              </div>
                              <div class="form-group half-width padding-right">
                                 <label for="card-expiry">Data di scadenza (MM/YY) <span class="required">*</span></label>
