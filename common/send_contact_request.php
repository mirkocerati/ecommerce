...
$query_result = SQL::getInstance()->Insert("INSERT INTO `contact_requests` (`name`, `email`, `subject`, `message`, `time`) VALUES (?, ?, ?, ?, current_timestamp())", ["ssss", $name, $email, $subject, $message]);
